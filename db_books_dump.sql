...
CREATE TABLE `tbl_books` (
  ...
  `b_author` char(255) DEFAULT NULL,
  `b_topic` int(11) DEFAULT NULL,
  `b_price` float(4,2) DEFAULT NULL,
  PRIMARY KEY (`b_id`),
  KEY `b_topic` (`b_topic`),
...
INSERT INTO `tbl_books` VALUES ('0-14-89-357','The Boy who was Raised as a Dog','Bruce Perry',4,10.89),('0-266-11156','Moby-Dick','Herman Melville',1,33.00),('0-4-198-63','Essays','Michel de Montaigne',5,38.50),('0-71-389-5-7','The Waste Land','T. S. Eliot',2,17.16),('0-77-356-98','Catch-22','Joseph Heller',1,22.00),('0-91-156-78','The Diary of a Young Girl','Anne Frank',3,12.10);
...
INSERT INTO `tbl_topics` VALUES (1,'classic'),(3,'memoirs'),(5,'philosophy'),(2,'poetry'),(4,'psychology');
...
-- Dump completed on 2020-04-10  1:07:09
